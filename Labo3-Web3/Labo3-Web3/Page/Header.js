        ...
        <div className="container">
          ...
          <div className="sidebar offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-center align-items-center fs-3 flex-grow-1 pe-3">
                <li className="nav-item mx-2">
                  <a className="nav-link active" aria-current="page" href="index.html">Acceuil</a>
                </li>
                <li className="nav-item mx-2">
                  <a className="nav-link" href="Forum.html">Forum</a>
                </li>
                <li className="nav-item mx-2">
                    <a className="nav-link" href="index.html">Aide</a>
                </li>
                <li className="nav-item mx-2">
                ...
                <div className="d-flex justify-content-end align-items-end">
                    <a className="text-white" href="#login">
                        <img src="images/Connexion.png" alt="Bootstrap" width="13%" height="1%"/>
                    </a>
                </div>
                </div>
            </div>
